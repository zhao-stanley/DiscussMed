    ...
    <>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <p className="text-lg leading-7 text-gray-500 dark:text-gray-400">Looking for more? Check out recommended research for further exploration, our curated podcasts for on the go listening, or our tips on disease/disorder advocacy.</p>
        </div>
        <div className="container py-12">
          <div className="-m-4 flex flex-wrap">
            ...
            <Card
              ...
              title={'Podcasts'}
              description={
                `Listen to our curated list of podcasts covering an extensive number of diseases/disorders.`
              }
