            ...
            <div>
              ...
              <div className="flex flex-col items-center rounded-2xl bg-white px-4 py-2 drop-shadow-lg">
                <div className="flex w-full flex-row items-center justify-around">
                  ...
                  >
                    <Image src={acscan} draggable="false"></Image>
                  </Link>
                  ...
                  <div className="flex h-min w-auto max-w-[15vw] flex-col items-center gap-1 lg:max-w-[10vw]">
                    <Image src={roslynmha} draggable="false"></Image>
                    <span className="select-none whitespace-nowrap text-xs font-semibold text-black lg:text-base">
                      Roslyn MHA Club
                    </span>
                  </div>
                </div>
