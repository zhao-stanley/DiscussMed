  ...
  return (
    <div className="my-6 flex h-auto flex-col gap-6">
      ...
      <div className="flex flex-col items-center">
        <ul className="grid h-auto w-[95vw] sm:w-auto grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
          <li className="flex h-auto w-auto flex-row items-center gap-3 rounded-lg bg-gray-100 p-4 drop-shadow-lg  dark:bg-[#2b2929]">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-row flex-wrap gap-1 whitespace-nowrap sm:gap-2">
          ...
          <li className="flex h-auto w-auto flex-row items-center gap-3 rounded-lg bg-gray-100 p-4 drop-shadow-lg dark:bg-[#2b2929]">
            ...
            <div className="flex flex-col gap-1">
              <h1 className="whitespace-nowrap text-xl font-semibold">Stanley Zhao</h1>
